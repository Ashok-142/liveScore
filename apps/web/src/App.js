...
export default function App() {
    ...
    const tournamentPanel = (_jsxs("section", { className: "panel tournament-panel", children: [_jsx("h2", { children: "Create Tournaments" }), _jsxs("form", { onSubmit: createTournament, children: [_jsxs("label", { children: ["Tournament Name", _jsx("input", { value: tournamentForm.name, onChange: (e) => setTournamentForm((prev) => ({ ...prev, name: e.target.value })), required: true, placeholder: "Summer Cup 2026" })] }), _jsxs("div", { className: "tournament-team-picker", children: [_jsxs("p", { children: ["Select Teams (", tournamentForm.teamIds.length, ")"] }), teams.length < 2 ? _jsx("p", { className: "warning", children: "Create at least 2 teams before creating a tournament." }) : null, _jsx("div", { className: "tournament-team-chips", children: teams.map((team) => {
                                ...
                                }) })] }), _jsx("button", { disabled: busy || tournamentForm.teamIds.length < 2, children: "Create Tournament" })] }), _jsxs("div", { className: "tournament-list", children: [_jsx("h3", { children: "Created Tournaments" }), tournaments.length === 0 ? (_jsx("p", { children: "No tournaments created yet." })) : (_jsx("ul", { className: "list compact tournament-items", children: tournaments.map((tournament) => (_jsxs("li", { children: [_jsx("strong", { children: tournament.name }), _jsxs("small", { children: ["By ", tournament.createdBy.name, " (", tournament.createdBy.playerId, ") on", " ", new Date(tournament.createdAt).toLocaleDateString()] }), _jsxs("span", { children: ["Teams:", " ", tournament.teams
                                            .map((entry) => `${entry.team.name} (${entry.team.shortCode})`)
                                            .join(", ")] })] }, tournament.id))) }))] }), _jsxs("div", { className: "tournament-list", children: [_jsx("h3", { children: "Start Match (Tournament)" }), _jsxs("div", { className: "tabs", children: [_jsx("button", { type: "button", className: setupTab === "create" ? "active" : "", onClick: () => setSetupTab("create"), children: "Create Match" }), _jsx("button", { type: "button", className: setupTab === "playingXI" ? "active" : "", onClick: () => setSetupTab("playingXI"), children: "Playing XI + Toss" })] }), setupTab === "create" ? (_jsxs("form", { onSubmit: createMatch, children: [_jsxs("label", { children: ["Tournament", _jsxs("select", { value: selectedTournamentIdForMatch, onChange: (e) => setSelectedTournamentIdForMatch(e.target.value), required: true, children: [_jsx("option", { value: "", children: "Select tournament" }), tournaments.map((tournament) => (_jsx("option", { value: tournament.id, children: tournament.name }, tournament.id)))] })] }), _jsxs("label", { children: ["Home Team", _jsxs("select", { value: matchForm.homeTeamId, onChange: (e) => setMatchForm((prev) => ({ ...prev, homeTeamId: e.target.value })), required: true, disabled: selectedTournamentTeams.length < 2, children: [_jsx("option", { value: "", children: "Select team" }), selectedTournamentTeams.map((team) => (_jsxs("option", { value: team.id, children: [team.name, " (", team.shortCode, ")"] }, team.id)))] })] }), _jsxs("label", { children: ["Away Team", _jsxs("select", { value: matchForm.awayTeamId, onChange: (e) => setMatchForm((prev) => ({ ...prev, awayTeamId: e.target.value })), required: true, disabled: selectedTournamentTeams.length < 2, children: [_jsx("option", { value: "", children: "Select team" }), selectedTournamentTeams
                                                .filter((team) => team.id !== matchForm.homeTeamId)
                                                .map((team) => (_jsxs("option", { value: team.id, children: [team.name, " (", team.shortCode, ")"] }, team.id)))] })] }), _jsxs("label", { children: ["Overs", _jsx("input", { type: "number", min: 1, max: 50, value: matchForm.oversLimit, onChange: (e) => setMatchForm((prev) => ({ ...prev, oversLimit: Number(e.target.value) })) })] }), _jsx("button", { disabled: busy || selectedTournamentTeams.length < 2, children: "Create Scheduled Match" })] })) : (_jsxs("div", { className: "setup-panel", children: [_jsxs("label", { children: ["Scheduled Match", _jsxs("select", { value: setupMatchId, onChange: (e) => setSetupMatchId(e.target.value), children: [_jsx("option", { value: "", children: "Select scheduled match" }), matches
    ...
    return (_jsxs("div", { className: "page", children: [_jsxs("header", { className: "top-nav", children: [_jsxs("div", { className: "brand-lockup", children: [_jsx("h1", { children: "Culbcric" }), _jsx("span", { children: "Live Scores" })] }), _jsxs("div", { className: "nav-right", children: [_jsxs("nav", { className: "nav-links", children: [_jsx("button", { type: "button", className: activeTopTab === "home" ? "nav-tab active" : "nav-tab", onClick: () => setActiveTopTab("home"), children: "Home" }), _jsx("button", { type: "button", className: activeTopTab === "setup" ? "nav-tab active" : "nav-tab", onClick: () => setActiveTopTab("setup"), children: "Setup" }), _jsx("button", { type: "button", className: activeTopTab === "live" ? "nav-tab active" : "nav-tab", onClick: () => setActiveTopTab("live"), children: "Live Center" }), _jsx("button", { type: "button", className: activeTopTab === "stats" ? "nav-tab active" : "nav-tab", onClick: () => setActiveTopTab("stats"), children: "Stats Table" })] }), _jsxs("div", { className: "user-menu", ref: userMenuRef, children: [_jsxs("button", { type: "button", className: "user-menu-trigger", "aria-label": "Open profile menu", "aria-expanded": showUserMenu, onClick: () => setShowUserMenu((prev) => !prev), children: [_jsx("span", {}), _jsx("span", {}), _jsx("span", {})] }), showUserMenu ? (_jsxs("div", { className: "user-menu-dropdown", children: [_jsxs("div", { className: "user-menu-head", children: [_jsx("strong", { children: authUser.name }), _jsx("p", { children: authUser.email }), _jsxs("p", { children: ["Player ID: ", authUser.playerId] })] }), _jsxs("div", { className: "user-menu-admin", children: [_jsx("p", { children: _jsxs("strong", { children: ["Admin Teams (", manageableTeams.length, ")"] }) }), manageableTeams.length === 0 ? (_jsx("p", { children: "No admin access assigned yet." })) : (_jsx("ul", { className: "user-menu-admin-list", children: manageableTeams.map((team) => (_jsxs("li", { children: [team.name, " (", team.shortCode, ")"] }, team.id))) }))] }), _jsx("button", { type: "button", className: "secondary", onClick: () => {
                                                    setShowUserMenu(false);
                                                    void logout();
                                                }, disabled: busy, children: "Logout" })] })) : null] })] })] }), error ? _jsx("div", { className: "error", children: error }) : null, activeTopTab === "home" ? playerHomePanel : null, activeTopTab === "setup" ? _jsxs("section", { className: "setup-layout", children: [createTeamPanel, tournamentPanel] }) : null, activeTopTab === "live" || activeTopTab === "stats" ? _jsxs("section", { className: "ticker-strip", children: [matches.length === 0 ? _jsx("p", { children: "No matches yet." }) : null, matches.map((match) => {
                        const home = teams.find((team) => team.id === match.homeTeamId);
                        const away = teams.find((team) => team.id === match.awayTeamId);
                    ...
                    })] }) : null, activeTopTab === "live" ? _jsxs("div", { className: "main-layout", children: [_jsx("section", { className: "main-column", children: !hasStartedMatch ? (_jsxs("article", { className: "panel", children: [_jsx("h2", { children: "Live Scoring" }), _jsx("p", { children: "Start a scheduled match from the Setup tab to unlock live scoring." })] })) : (_jsxs(_Fragment, { children: [_jsxs("article", { className: "panel hero-panel", children: [!activeMatch ? _jsx("p", { children: "Select a match to view scorecard." }) : null, activeMatch ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: "hero-meta", children: [_jsx("span", { className: activeMatch.summary.status === "LIVE" ? "status-pill live" : "status-pill", children: activeMatch.summary.status }), _jsxs("span", { children: [activeHomeTeam?.name ?? "Home", " vs ", activeAwayTeam?.name ?? "Away"] }), activeTossWinner ? (_jsxs("span", { children: ["Toss: ", activeTossWinner.shortCode, " chose ", activeMatch.summary.tossDecision] })) : null] }), _jsx("div", { className: "score-rows", children: activeMatch.summary.innings.map((innings) => {
                                                        const inningsTeam = teams.find((team) => team.id === innings.battingTeamId);
                                                        return (_jsxs("div", { className: "score-row", children: [_jsx("span", { children: inningsLabel(innings.number) }), _jsx("strong", { children: inningsTeam?.shortCode ?? "TEAM" }), _jsxs("strong", { children: [innings.runs, "/", innings.wickets] }), _jsxs("span", { children: [innings.overDisplay, " overs"] })] }, innings.id));
                                                    }) }), matchResultText ? _jsx("p", { className: "result-line", children: matchResultText }) : null] })) : null] }), _jsxs("article", { className: "panel live-panel", children: [_jsx("h2", { children: "Live Scoring" }), !activeMatchListItem ? _jsx("p", { children: "Select a match." }) : null, activeMatchListItem && activeMatchListItem.status === "SCHEDULED" ? (_jsx("p", { children: "This match is scheduled. Open Setup tab, then Create Tournaments to select Playing XI and toss, then start live scoring." })) : null, !activeMatch || !currentInnings ? null : (_jsxs(_Fragment, { children: [_jsxs("div", { className: "score", children: [_jsx("strong", { children: teams.find((team) => team.id === currentInnings.battingTeamId)?.name ?? "Batting Team" }), _jsxs("span", { children: [currentInnings.runs, "/", currentInnings.wickets] }), _jsx("small", { children: currentInningsTitle }), _jsxs("small", { children: ["Overs: ", currentInnings.overDisplay, " / ", activeMatch.summary.oversLimit] }), chaseTarget ? _jsxs("small", { children: ["Target: ", chaseTarget] }) : null] }), isLiveMatch ? (_jsxs("div", { className: "quick-score", children: [showBowlerPrompt ? (_jsx("div", { className: "overlay", children: _jsxs("div", { className: "overlay-card", children: [_jsx("h3", { children: "Over Complete" }), _jsx("p", { children: "Select bowler for the next over." }), _jsx("select", { value: nextBowlerId, onChange: (e) => setNextBowlerId(e.target.value), children: bowlingTeamPlayers.map((player) => (_jsx("option", { value: player.id, children: player.name }, player.id))) }), _jsx("button", { type: "button", onClick: confirmNextOverBowler, children: "Confirm Bowler" })] }) })) : null, _jsxs("div", { className: "selector-row", children: [_jsxs("label", { children: ["Striker", _jsx("select", { value: eventActors.strikerId, onChange: (e) => setEventActors((prev) => ({ ...prev, strikerId: e.target.value })), disabled: showBowlerPrompt, children: battingTeamPlayers.map((player) => (_jsx("option", { value: player.id, children: player.name }, player.id))) })] }), _jsxs("label", { children: ["Non-striker", _jsx("select", { value: eventActors.nonStrikerId, onChange: (e) => setEventActors((prev) => ({ ...prev, nonStrikerId: e.target.value })), disabled: showBowlerPrompt, children: battingTeamPlayers.map((player) => (_jsx("option", { value: player.id, children: player.name }, player.id))) })] }), _jsxs("label", { children: ["Bowler", _jsx("select", { value: eventActors.bowlerId, onChange: (e) => setEventActors((prev) => ({ ...prev, bowlerId: e.target.value })), disabled: showBowlerPrompt, children: bowlingTeamPlayers.map((player) => (_jsx("option", { value: player.id, children: player.name }, player.id))) })] }), _jsx("button", { type: "button", onClick: swapBatters, className: "secondary", disabled: showBowlerPrompt, children: "Swap Strike" })] }), _jsxs("label", { children: ["Quick Commentary (optional)", _jsx("input", { value: commentary, onChange: (e) => setCommentary(e.target.value), placeholder: "Optional short note", maxLength: 240, disabled: showBowlerPrompt })] }), _jsxs("div", { className: "quick-actions", children: [_jsx("h3", { children: "Runs (one click)" }), _jsx("div", { className: "button-row", children: [0, 1, 2, 3, 4, 6].map((run) => (_jsx("button", { type: "button", onClick: () => void submitBallEvent({
                                                                            runsOffBat: run,
                                                                            extraType: "NONE",
                                                                            extraRuns: 0,
                                                                            isWicket: false,
                                                                            wicketType: "NONE"
                                                                        }), disabled: scoringLocked, children: run }, run))) })] }), _jsxs("div", { className: "quick-actions", children: [_jsx("h3", { children: "Extras (one click)" }), _jsxs("div", { className: "button-row", children: [_jsx("button", { type: "button", disabled: scoringLocked, onClick: () => void submitBallEvent({
                                                                                runsOffBat: 0,
                                                                                extraType: "WIDE",
                                                                                extraRuns: 1,
                                                                                isWicket: false,
                                                                                wicketType: "NONE"
                                                                            }), children: "Wide +1" }), _jsx("button", { type: "button", disabled: scoringLocked, onClick: () => void submitBallEvent({
                                                                                runsOffBat: 0,
                                                                                extraType: "NO_BALL",
                                                                                extraRuns: 1,
                                                                                isWicket: false,
                                                                                wicketType: "NONE"
                                                                            }), children: "No Ball +1" }), _jsx("button", { type: "button", disabled: scoringLocked, onClick: () => void submitBallEvent({
                                                                                runsOffBat: 0,
                                                                                extraType: "BYE",
                                                                                extraRuns: 1,
                                                                                isWicket: false,
                                                                                wicketType: "NONE"
                                                                            }), children: "Bye +1" }), _jsx("button", { type: "button", disabled: scoringLocked, onClick: () => void submitBallEvent({
                                                                                runsOffBat: 0,
                                                                                extraType: "LEG_BYE",
                                                                                extraRuns: 1,
                                                                                isWicket: false,
                                                                                wicketType: "NONE"
                                                                            }), children: "Leg Bye +1" })] })] }), _jsxs("div", { className: "quick-actions", children: [_jsx("h3", { children: "Wicket" }), _jsxs("div", { className: "button-row", children: [_jsx("select", { value: quickWicketType, onChange: (e) => setQuickWicketType(e.target.value), disabled: showBowlerPrompt, children: WICKET_TYPES.filter((value) => value !== "NONE").map((value) => (_jsx("option", { value: value, children: value }, value))) }), quickWicketType === "RUN_OUT" ? (_jsxs("select", { value: quickDismissedBatter, onChange: (e) => setQuickDismissedBatter(e.target.value), disabled: showBowlerPrompt, children: [_jsx("option", { value: "STRIKER", children: "Out: Striker" }), _jsx("option", { value: "NON_STRIKER", children: "Out: Non-striker" })] })) : null, ["CAUGHT", "RUN_OUT", "STUMPED"].includes(quickWicketType) ? (_jsxs("select", { value: quickFielderId, onChange: (e) => setQuickFielderId(e.target.value), disabled: showBowlerPrompt || bowlingTeamPlayers.length === 0, children: [bowlingTeamPlayers.length === 0 ? _jsx("option", { value: "", children: "No fielder available" }) : null, bowlingTeamPlayers.map((player) => (_jsxs("option", { value: player.id, children: ["Fielder: ", player.name] }, player.id)))] })) : null, _jsxs("select", { value: quickIncomingBatterId, onChange: (e) => setQuickIncomingBatterId(e.target.value), disabled: showBowlerPrompt || nextBatterOptions.length === 0, children: [nextBatterOptions.length === 0 ? _jsx("option", { value: "", children: "No batter available" }) : null, nextBatterOptions.map((player) => (_jsxs("option", { value: player.id, children: ["Incoming: ", player.name] }, player.id)))] }), _jsxs("label", { className: "checkbox-row inline-check", children: [_jsx("input", { type: "checkbox", checked: quickCrossedBeforeDismissal, onChange: (e) => setQuickCrossedBeforeDismissal(e.target.checked), disabled: showBowlerPrompt }), "Crossed before dismissal"] }), _jsx("button", { type: "button", disabled: scoringLocked ||
